...
![01](./img/07d2d8250461268d34720cd75ad0047e_MD5.png)

2. 进入编辑界面，使用键盘上的上下键把光标往下移动，找以““Linux16”开头内容所在的行数”，在行的最后面输入：init=/bin/sh。如图

![02](./img/0f9b39cd0b1b343d7829601541732adf_MD5.png)
...
![03](./img/5fc355c68db7126e5400f41c94da86c6_MD5.png)
...
![04](./img/7b4a4992eac497d3481b8ada57bf76fb_MD5.png)
