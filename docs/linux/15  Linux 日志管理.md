...
![02](./img/c9104ea4e126ed44a3382f426467387b_MD5.png)
...
在/etc/rsyslog.conf 中添加一个日志文件/var/log/mgxy.log,当有事件发送时(比如sshd服务相关事件)，该文件会接收到信息并保存.给小伙伴演示重启，登录的情况，看看是否有日志保存
...
看一个案例，在/etc/logrotate.conf进行配置,或者直接在letc/logrotate.d下创建文件 mgxylog 编写如下内容，具体轮替的效果可以参考/var/log下的boot.log情况.
...
![05](./img/ff9cf1125bb82a4712ba8b5cfb7dd32d_MD5.png)
