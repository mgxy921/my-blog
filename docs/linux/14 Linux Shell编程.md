...
![01](./img/e120ead80210e3486fe95beea05a822e_MD5.png)
...
![02](./img/903a69104ae44f31a01db41954facd08_MD5.png)
...
3. 在另外一个shell程序中使用TOMCAT_HOME
   ...
   **source /etc/profile**
   ...
   ![03](./img/5260cdeaa646e8ea69e5015760569ad3_MD5.png)
...
+ 应用实例
  ...
  1. 每天凌晨2:30备份数据库mgxy921到/data/backup/db
  2. 备份开始和备份结束能够给出相应的提示信息
  3. 备份后的文件要求以备份时间为文件名，并打包成.tar.gz 的形式，比如:2021-03-12_230201.tar .gz
  4. 在备份的同时，检查是否有10天前备份的数据库文件，如果有就将其删除。
  5. 画一个思路分析图

![04](./img/99591dcbce2177a397de88173bd87d96_MD5.png)
