...
![image](./img/6369d2afca4fe6e90da6aa17bf6238f5_MD5.png)
...
![image](./img/5d13e39c484846b09af17158011c8e0f_MD5.png)
...
![](./img/3192fd958f8d889713674a9bb9c469ab_MD5.png)
...
![](./img/3aa1c0f127b86048048c0e859d02e5b0_MD5.png)
...
![image](./img/f6005cdac95c618f0147d544e262153c_MD5.png)

`默认`情况下，移动端的网页都会将视口设置为 `980像素`（css像素）。 以确保pc端网页可以在移动端正常访问，但是如果网页的宽度超过了980，移动端的浏览器会 `自动对网页缩放`以完整显示网页。

![image](./img/5de72c4006b33c3facbda99c760e628e_MD5.png)
...
> iphone6 414px
>
> ![image](./img/74a3ee8381428a9f0563ffa5dbf5d96b_MD5.png)
...
![image](./img/f2844f00dce0b4992bd9a9825aa488da_MD5.png)
...
![](./img/277ee56176895a64e21ed7b822ad21a8_MD5.png)
...
![](./img/d3720f3def10530aba22d9b14ed2abcf_MD5.jpg)
...
![](./img/c7fe579891d922e415a6b08581f85611_MD5.png)
...
![image](./img/22101948e3076278cdf9adb3deebb751_MD5.png)
...
![](./img/22101948e3076278cdf9adb3deebb751_MD5.png)

当图片是竖直放置时：

![](./img/eee9d74a19ed386bbac481827053d015_MD5.png)
...
![](./img/e828b2bfd8d538b8bc7f06c848383009_MD5.png)
...
![](./img/e27842ef280bf78dc025f46e9b9f3e91_MD5.png)

![](./img/be2cb201d562b96003c7c860beae25fc_MD5.png)
...
![](./img/b30129ad0b92fdaf03dd64fa3994fbfe_MD5.gif)

### 6.2 搜索框

![](./img/47eb4968c6e716de73e83c1670b9bf6b_MD5.png)

![ssk](./img/5a2495b325f98db6b7b0a30b889b460d_MD5.gif)

可以看到，当页面宽度变化时，搜索框会同步变宽，但是左右两边的按钮是不会变化的，实现这个功能的原理是：

![](./img/da8798b47470a4b45be751e01e52edf5_MD5.png)
...
![](./img/6b45a6e409ba16e25eb5b6e78c33a00f_MD5.jpg)
...
![](./img/fa45cd52a50e6dd1568ea96357cf10d7_MD5.png)
...
![](./img/667b7dd40432f3f776c173cc87a22cad_MD5.jpg)
